...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
(()=>{
    const e = new Error("Cannot find module '.useLocalStorage'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
function OrderProvider({ children }) {
    ...
    const [orders, setOrders] = useLocalStorage('order-history', []);
    ...
    const addOrder = (orderData)=>{
        ...
        // Yangi buyurtmani ro'yxatning boshiga qo'shamiz
...
_s1(OrderProvider, "scE4qkOxddEHihQjNP42pozyekQ=", false, function() {
    return [
        useLocalStorage
    ];
});
...
//# sourceMappingURL=_9a0c790d._.js.map